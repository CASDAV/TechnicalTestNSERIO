...
namespace SalesDatePrediction.Infrastructure.Persistance;

public partial class SalesPredictionDbContext : DbContext
{
    public SalesPredictionDbContext(DbContextOptions<SalesPredictionDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<SaleDatePrediction> SaleDatePredictions { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SaleDatePrediction>(entity =>
        {
            entity.HasNoKey();
            entity.Property(e => e.CustomerName).HasColumnName("CustomerName");
            entity.Property(e => e.LastOrderDate).HasColumnName("LastOrderDate");
            entity.Property(e => e.NextPredictedOrder).HasColumnName("NextPredictedOrder");
        });
